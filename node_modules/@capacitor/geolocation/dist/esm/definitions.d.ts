 ...
 * @since 1.0.0
 */
export declare type GeolocationOptions = PositionOptions;
/**
 * @deprecated Use `WatchPositionCallback`.
 * @since 1.0.0
 */
export declare type GeolocationWatchCallback = WatchPositionCallback;
/**
 * @deprecated Use `Position`.
 * @since 1.0.0
 */
export declare type GeolocationPosition = Position;
